...
program PassingUnderLeagueRaceF90
    ...
    do
        ...
        write(10, '(F6.2, F6.2, F6.2, F6.2, F6.2, F6.2, F6.2, F6.2, F6.2)') lapsEvent, stops, lapTank, &
        lapsRun, gallonsStart, gallonsRemaining, lapsPerGallon, setTankPercent, stintLaps
